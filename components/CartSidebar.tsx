...
<<<<<<< HEAD
        ...
        {totalItems() > 0 && (
          <span className="absolute top-0 right-0 bg-[#D4870A] text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold">
=======
        <svg
          className="h-6 w-6"
          fill="none"
...
<<<<<<< HEAD
        className={`fixed inset-y-0 right-0 w-full sm:w-96 bg-white shadow-2xl z-[60] flex flex-col
          border-l border-gray-100 transform transition-transform duration-300
          ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
        {/* Header */}
        <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-[#6B1E2E] text-white">
          <h2
        ...
        <div className="flex-grow overflow-y-auto p-4 space-y-4">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="px-6 py-2 bg-[#D4870A] text-white rounded-full font-bold text-sm"
=======
        {/* ── ITEMS ── */}
...
<<<<<<< HEAD
            ...
            items.map((item) => (
              <div key={item.id} className="flex items-center space-x-4 pb-4 border-b border-gray-100">
                <div className="h-20 w-20 flex-shrink-0 rounded relative overflow-hidden">
                ...
                <div className="flex-grow">
                  ...
                  <p
                    className="text-[#6B1E2E] text-sm font-semibold"
                    style={{ fontFamily: 'DM Sans, sans-serif' }}
                  >
                    {item.priceLabel}
                  </p>
                  <div className="flex items-center mt-2 space-x-3">
                    <button
                      ...
                      className="w-6 h-6 border border-gray-300 flex items-center justify-center rounded-full hover:bg-gray-100 font-bold"
                    >-</button>
                    <span
        ...
        {items.length > 0 && (
          <div className="p-6 border-t border-gray-100 bg-gray-50">
            ...
            {subtotal() < 2000 && (
              <p
                className="text-xs text-[#D4870A] mb-4"
                style={{ fontFamily: 'DM Sans, sans-serif' }}
              >
            ...
            <Link
              href="/checkout"
              onClick={() => setIsOpen(false)}
              className="block w-full py-4 bg-[#6B1E2E] text-white font-bold rounded text-center hover:bg-black transition-all uppercase tracking-widest text-sm"
              style={{ fontFamily: 'DM Sans, sans-serif' }}
            >
              Checkout Now
            </Link>
            <p
              className="text-center text-xs text-gray-400 mt-4 uppercase"
              style={{ fontFamily: 'DM Sans, sans-serif' }}
            >
